...
set rc [catch {
  ...
  set_property webtalk.parent_dir F:/programs/FPGA/game/game/game.cache/wt [current_project]
  set_property parent.project_path F:/programs/FPGA/game/game/game.xpr [current_project]
  set_property ip_output_repo F:/programs/FPGA/game/game/game.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet F:/programs/FPGA/game/game/game.runs/synth_1/top.dcp
  read_xdc F:/programs/FPGA/game/game/game.srcs/constrs_1/new/game.xdc
